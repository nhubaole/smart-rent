...
class TenantRentRequestSuccessPage
    extends GetView<TenantRentRequestSuccessController> {
  const TenantRentRequestSuccessPage({super.key});
    ...
    return Padding(
      ...
      child: Text.rich(
        ...
        TextSpan(
          children: [
            TextSpan(
                text: 'Bạn có thể theo dõi trạng thái yêu cầu trong phần'.tr),
            const TextSpan(text: ' '),
            TextSpan(
              text: 'Quản lý yêu cầu'.tr,
  ...
  Widget _buildSentSuccessDes() {
    ...
    return Container(
      ...
      child: Text.rich(
        ...
        TextSpan(
            text:
                'Yêu cầu của bạn đã được gửi đến chủ nhà. Vui lòng chờ phản hồi từ chủ nhà.'
                    .tr),
      ),
    );
  }
