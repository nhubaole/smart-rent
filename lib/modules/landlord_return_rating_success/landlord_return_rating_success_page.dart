...
class LandlordReturnRatingSuccessPage
    extends GetView<LandlordReturnRatingController> {
  const LandlordReturnRatingSuccessPage({super.key});
      ...
      child: Column(
        children: [
          Text.rich(
            ...
            textAlign: TextAlign.center,
            TextSpan(
              text: 'Cảm ơn bạn đã gửi đánh giá! '.tr,
            ),
          ),
          SizedBox(height: 16.px),
          Text.rich(
            ...
            TextSpan(
              text:
                  'Đánh giá của bạn sẽ giúp chúng tôi cải thiện chất lượng dịch vụ và hỗ trợ những chủ nhà khác có thông tin tốt hơn.'
                      .tr,
            ),
          ),
        ],
  ...
  Text _buildSentSuccess() {
    return Text.rich(
      ...
      textAlign: TextAlign.center,
      TextSpan(text: 'Đánh giá thành công'.tr),
    );
  }
