    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Obx(
          ...
          //       final RoomResponseModel item = controller.listRoom.value[index];
          //       return Container(
          ...
          //                     Text(
          //                         'roomType: ${item.roomType.isEmpty ? 'School' : item.roomType}'),
          //                     Text('capacity: ${item.capacity}'),
          //                     Text(
          //                         'gender: ${item.gender.isEmpty ? 'male & female' : item.gender}'),
          ...
          //                     Text('hasParking: ${item.hasParking}'),
          //                     Text('parkingFree: ${item.parkingFee}'),
          //                     Text('locaiton: ${item.location}'),
          //                   ],
          //                 ),
          //               ],
          //             ),
